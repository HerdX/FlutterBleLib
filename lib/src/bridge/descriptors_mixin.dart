...
mixin DescriptorsMixin on FlutterBLE {
  Future<DescriptorWithValue> readDescriptorForPeripheral(
    ...
    String transactionId,
      ...
      .invokeMethod(MethodName.readDescriptorForDevice, <String, dynamic>{
      ...
      .then((jsonResponse) {
        ...
        Characteristic characteristic = Characteristic.fromJson(
          jsonObject,
          service,
          _manager,
        );
  ...
  Future<DescriptorWithValue> readDescriptorForService(
    ...
    String transactionId,
      ...
      .invokeMethod(MethodName.readDescriptorForService, <String, dynamic>{
  ...
  Future<Uint8List> readDescriptorForIdentifier(
    ...
    String transactionId,
      ...
      .invokeMethod(MethodName.readDescriptorForIdentifier, <String, dynamic>{
  ...
  Future<Descriptor> writeDescriptorForPeripheral(
    ...
    String transactionId,
      ...
      .invokeMethod(MethodName.writeDescriptorForDevice, <String, dynamic>{
        ArgumentName.deviceIdentifier: peripheral.identifier,
        ArgumentName.serviceUuid: serviceUuid,
        ArgumentName.characteristicUuid: characteristicUuid,
        ArgumentName.descriptorUuid: descriptorUuid,
  ...
  Future<Descriptor> writeDescriptorForService(
    ...
    String transactionId,
      ...
      .invokeMethod(MethodName.writeDescriptorForService, <String, dynamic>{
        ArgumentName.serviceIdentifier: service._id,
        ArgumentName.characteristicUuid: characteristicUuid,
        ArgumentName.descriptorUuid: descriptorUuid,
        ArgumentName.value: value,
  ...
  Future<void> writeDescriptorForIdentifier(
    ...
    String transactionId,
      ...
      .invokeMethod(MethodName.writeDescriptorForIdentifier, <String, dynamic>{
        ArgumentName.descriptorIdentifier: descriptor._id,
        ArgumentName.value: value,
        ArgumentName.transactionId: transactionId,
      })
  ...
  Future<void> _handleError(Object error, [dynamic stacktrace]) => Future.error(
    BleError.fromJson(jsonDecode((error as PlatformException).details)),
  );
}
