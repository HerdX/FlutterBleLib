...
mixin DeviceConnectionMixin on FlutterBLE {
  final Stream<dynamic> _peripheralConnectionStateChanges = const EventChannel(
    ChannelName.connectionStateChangeEvents,
  ...
  Stream<PeripheralConnectionState> observePeripheralConnectionState(
    ...
    controller
        .addStream(sourceStream, cancelOnError: true)
